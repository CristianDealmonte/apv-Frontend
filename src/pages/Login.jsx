...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Almacenamos en localStorage el JWT que nos retorna
    ...
    return(
        <>
            <div>
                <h1 className="text-indigo-600 font-black text-5xl md:text-6xl">Inicia Sesión y Administra tus <span className="text-black">Pacientes</span> </h1>
            </div>
